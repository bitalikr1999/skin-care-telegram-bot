...
export class StatisticsUtils {
  public static calculate_activity_correlations(
    days: IRatedDay[],
    ...
    for (const activity_key of activity_keys) {
      ...
      const avg_with = StatisticsUtils._average(with_activity);
      const avg_without =
        StatisticsUtils._average(without_activity);
    ...
    return {
      ...
      top_positive: [...sorted_by_diff]
        .reverse()
        .slice(0, TOP_COUNT),
    };
  }

  private static _average(values: number[]): number {
